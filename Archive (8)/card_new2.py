...
def get_data_for_player_best_matches(selected_player_name, leaderboardx, reference_players):
    ...
    for k in funcs:
        ...
        if k not in ['return_speed_reduction_break', 'serve_speed_reduction_pressure', 'rally_winners_per_match', 'rally_ue_per_match']:
            ...
            if k not in ['rally_winners_per_match', 'rally_ue_per_match', 'fh_rally_winners_and_forcing_error_per_match', 'bh_rally_winners_and_forcing_error_per_match',]:
...
def get_data_for_matches_new(selected_player_name, leaderboardx, match_ids=[]):
    ...
    for sets in ['ALL', '1', '2', '3', '4', '5']:
        ...
        for k in funcs:
            ...
            if leaderboard[f'{k}_total'].sum() < 0 and k not in ['return_speed_reduction_break', 'serve_speed_reduction_pressure', 'rally_winners_per_match', 'rally_ue_per_match', 'fh_rally_winners_and_forcing_error_per_match', 'bh_rally_winners_and_forcing_error_per_match',]:
