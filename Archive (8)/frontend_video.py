...
from azure_client import container_client, azure_upload_file, azure_upload_docx
from utils_shot_evolution import create_shot_evolution
from utils_serve_comparison import create_serve_comparison # type: ignore


CUSTOM_CLIPS = {
    'Serve': {
        '1st Serves: Unreturned & Aces': 'https://operationslakedb.blob.core.windows.net/gsa-operations/custom-clips/FILS_Doha_2026_F_Alcaraz_Fils_new/0---1st%20Serves%3A%20Unreturned%20%26%20Aces.mp4?sp=racwdlmeop&st=2026-01-06T11:30:32Z&se=2026-02-28T19:45:32Z&spr=https&sv=2024-11-04&sr=c&sig=fJkceZLZRq%2Fr%2FAFlzAY1%2BjgoQozDo%2FwGYSBOyw6HzAo%3D',
        '1st Serves: Missed': 'https://operationslakedb.blob.core.windows.net/gsa-operations/custom-clips/FILS_Doha_2026_F_Alcaraz_Fils_new/1---1st%20Serves%3A%20Missed.mp4?sp=racwdlmeop&st=2026-01-06T11:30:32Z&se=2026-02-28T19:45:32Z&spr=https&sv=2024-11-04&sr=c&sig=fJkceZLZRq%2Fr%2FAFlzAY1%2BjgoQozDo%2FwGYSBOyw6HzAo%3D',
        '1st Serves +1 Winner + Forcing: Ad': 'https://operationslakedb.blob.core.windows.net/gsa-operations/custom-clips/FILS_Doha_2026_F_Alcaraz_Fils_new/2---1st%20Serves%20with%20%2B1%20Winner%20%2B%20Forcing%20Shots%3A%20Ad.mp4?sp=racwdlmeop&st=2026-01-06T11:30:32Z&se=2026-02-28T19:45:32Z&spr=https&sv=2024-11-04&sr=c&sig=fJkceZLZRq%2Fr%2FAFlzAY1%2BjgoQozDo%2FwGYSBOyw6HzAo%3D',
        'All 2nd Serves': 'https://operationslakedb.blob.core.windows.net/gsa-operations/custom-clips/FILS_Doha_2026_F_Alcaraz_Fils_new/3---All%202nd%20Serves.mp4?sp=racwdlmeop&st=2026-01-06T11:30:32Z&se=2026-02-28T19:45:32Z&spr=https&sv=2024-11-04&sr=c&sig=fJkceZLZRq%2Fr%2FAFlzAY1%2BjgoQozDo%2FwGYSBOyw6HzAo%3D',
        '2nd Serve Strong Return: Deuce': 'https://operationslakedb.blob.core.windows.net/gsa-operations/custom-clips/FILS_Doha_2026_F_Alcaraz_Fils_new/4---2nd%20serve%20with%20strong%20return%20opponent%3A%20Deuce.mp4?sp=racwdlmeop&st=2026-01-06T11:30:32Z&se=2026-02-28T19:45:32Z&spr=https&sv=2024-11-04&sr=c&sig=fJkceZLZRq%2Fr%2FAFlzAY1%2BjgoQozDo%2FwGYSBOyw6HzAo%3D',
        '2nd Serve Strong Return: Ad': 'https://operationslakedb.blob.core.windows.net/gsa-operations/custom-clips/FILS_Doha_2026_F_Alcaraz_Fils_new/5---2nd%20serve%20with%20strong%20return%20opponent%3A%20Ad.mp4?sp=racwdlmeop&st=2026-01-06T11:30:32Z&se=2026-02-28T19:45:32Z&spr=https&sv=2024-11-04&sr=c&sig=fJkceZLZRq%2Fr%2FAFlzAY1%2BjgoQozDo%2FwGYSBOyw6HzAo%3D',
    },
    'Return': {
        'Missed Returns': 'https://operationslakedb.blob.core.windows.net/gsa-operations/custom-clips/FILS_Doha_2026_F_Alcaraz_Fils_new/6---Missed%20Returns.mp4?sp=racwdlmeop&st=2026-01-06T11:30:32Z&se=2026-02-28T19:45:32Z&spr=https&sv=2024-11-04&sr=c&sig=fJkceZLZRq%2Fr%2FAFlzAY1%2BjgoQozDo%2FwGYSBOyw6HzAo%3D',
        'Deep Returns': 'https://operationslakedb.blob.core.windows.net/gsa-operations/custom-clips/FILS_Doha_2026_F_Alcaraz_Fils_new/7---Deep%20Returns.mp4?sp=racwdlmeop&st=2026-01-06T11:30:32Z&se=2026-02-28T19:45:32Z&spr=https&sv=2024-11-04&sr=c&sig=fJkceZLZRq%2Fr%2FAFlzAY1%2BjgoQozDo%2FwGYSBOyw6HzAo%3D',
        'Return in but lost point': 'https://operationslakedb.blob.core.windows.net/gsa-operations/custom-clips/FILS_Doha_2026_F_Alcaraz_Fils_new/8---Return%20in%20but%20lost%20point.mp4?sp=racwdlmeop&st=2026-01-06T11:30:32Z&se=2026-02-28T19:45:32Z&spr=https&sv=2024-11-04&sr=c&sig=fJkceZLZRq%2Fr%2FAFlzAY1%2BjgoQozDo%2FwGYSBOyw6HzAo%3D',
        'Return in and won point': 'https://operationslakedb.blob.core.windows.net/gsa-operations/custom-clips/FILS_Doha_2026_F_Alcaraz_Fils_new/9---Return%20in%20and%20won%20point.mp4?sp=racwdlmeop&st=2026-01-06T11:30:32Z&se=2026-02-28T19:45:32Z&spr=https&sv=2024-11-04&sr=c&sig=fJkceZLZRq%2Fr%2FAFlzAY1%2BjgoQozDo%2FwGYSBOyw6HzAo%3D',
    },
    'Errors': {
        'Unforced Errors FH': 'https://operationslakedb.blob.core.windows.net/gsa-operations/custom-clips/FILS_Doha_2026_F_Alcaraz_Fils_new/13---Unforced%20Errors%20FH.mp4?sp=racwdlmeop&st=2026-01-06T11:30:32Z&se=2026-02-28T19:45:32Z&spr=https&sv=2024-11-04&sr=c&sig=fJkceZLZRq%2Fr%2FAFlzAY1%2BjgoQozDo%2FwGYSBOyw6HzAo%3D',
        'Unforced Errors BH': 'https://operationslakedb.blob.core.windows.net/gsa-operations/custom-clips/FILS_Doha_2026_F_Alcaraz_Fils_new/14---Unforced%20Errors%20BH.mp4?sp=racwdlmeop&st=2026-01-06T11:30:32Z&se=2026-02-28T19:45:32Z&spr=https&sv=2024-11-04&sr=c&sig=fJkceZLZRq%2Fr%2FAFlzAY1%2BjgoQozDo%2FwGYSBOyw6HzAo%3D',
    },
    'Rally Length': {
        'Won point in 5-8 shots': 'https://operationslakedb.blob.core.windows.net/gsa-operations/custom-clips/FILS_Doha_2026_F_Alcaraz_Fils_new/19---Won%20point%20in%205-8%20shots.mp4?sp=racwdlmeop&st=2026-01-06T11:30:32Z&se=2026-02-28T19:45:32Z&spr=https&sv=2024-11-04&sr=c&sig=fJkceZLZRq%2Fr%2FAFlzAY1%2BjgoQozDo%2FwGYSBOyw6HzAo%3D',
        'Lost point in 5-8 shots': 'https://operationslakedb.blob.core.windows.net/gsa-operations/custom-clips/FILS_Doha_2026_F_Alcaraz_Fils_new/20---Lost%20point%20in%205-8%20shots.mp4?sp=racwdlmeop&st=2026-01-06T11:30:32Z&se=2026-02-28T19:45:32Z&spr=https&sv=2024-11-04&sr=c&sig=fJkceZLZRq%2Fr%2FAFlzAY1%2BjgoQozDo%2FwGYSBOyw6HzAo%3D',
        'Won point in >8 shots': 'https://operationslakedb.blob.core.windows.net/gsa-operations/custom-clips/FILS_Doha_2026_F_Alcaraz_Fils_new/17---Won%20point%20in%20%3E8%20shots.mp4?sp=racwdlmeop&st=2026-01-06T11:30:32Z&se=2026-02-28T19:45:32Z&spr=https&sv=2024-11-04&sr=c&sig=fJkceZLZRq%2Fr%2FAFlzAY1%2BjgoQozDo%2FwGYSBOyw6HzAo%3D',
        'Lost point in >8 shots': 'https://operationslakedb.blob.core.windows.net/gsa-operations/custom-clips/FILS_Doha_2026_F_Alcaraz_Fils_new/18---Lost%20point%20in%20%3E8%20shots.mp4?sp=racwdlmeop&st=2026-01-06T11:30:32Z&se=2026-02-28T19:45:32Z&spr=https&sv=2024-11-04&sr=c&sig=fJkceZLZRq%2Fr%2FAFlzAY1%2BjgoQozDo%2FwGYSBOyw6HzAo%3D',
    },
    'Shots': {
        'FH Winners and Forcing Shots': 'https://operationslakedb.blob.core.windows.net/gsa-operations/custom-clips/FILS_Doha_2026_F_Alcaraz_Fils_new/21---FH%20Winners%20and%20Forcing%20Shots.mp4?sp=racwdlmeop&st=2026-01-06T11:30:32Z&se=2026-02-28T19:45:32Z&spr=https&sv=2024-11-04&sr=c&sig=fJkceZLZRq%2Fr%2FAFlzAY1%2BjgoQozDo%2FwGYSBOyw6HzAo%3D',
        'Opponent Winners and Forcing Shots': 'https://operationslakedb.blob.core.windows.net/gsa-operations/custom-clips/FILS_Doha_2026_F_Alcaraz_Fils_new/22---Opponent%20Hit%20Winners%20and%20Forcing%20Shots.mp4?sp=racwdlmeop&st=2026-01-06T11:30:32Z&se=2026-02-28T19:45:32Z&spr=https&sv=2024-11-04&sr=c&sig=fJkceZLZRq%2Fr%2FAFlzAY1%2BjgoQozDo%2FwGYSBOyw6HzAo%3D',
        'Passing Shots FH': 'https://operationslakedb.blob.core.windows.net/gsa-operations/custom-clips/FILS_Doha_2026_F_Alcaraz_Fils_new/23---Passing%20Shots%20FH.mp4?sp=racwdlmeop&st=2026-01-06T11:30:32Z&se=2026-02-28T19:45:32Z&spr=https&sv=2024-11-04&sr=c&sig=fJkceZLZRq%2Fr%2FAFlzAY1%2BjgoQozDo%2FwGYSBOyw6HzAo%3D',
        'Passing Shots BH': 'https://operationslakedb.blob.core.windows.net/gsa-operations/custom-clips/FILS_Doha_2026_F_Alcaraz_Fils_new/24---Passing%20Shots%20BH.mp4?sp=racwdlmeop&st=2026-01-06T11:30:32Z&se=2026-02-28T19:45:32Z&spr=https&sv=2024-11-04&sr=c&sig=fJkceZLZRq%2Fr%2FAFlzAY1%2BjgoQozDo%2FwGYSBOyw6HzAo%3D',
    },
}
...
def insert_serve_comparison_to_db(title):
    conn = None
    try:
        # Get a connection from the pool
        conn = connection_pool.getconn()
        ...
        if conn.closed:
            conn = connection_pool.getconn()
        cur = conn.cursor()
        title, idx = title.split('---')
        idx = idx.replace('.docx', '')
        link = ''
        status = 'IN PROGRESS'
        insert_sql = """
        
        INSERT INTO hawkeye_app.serve_comparison_table (idx, title, created_at, status, link)
        VALUES (%s, %s, %s, %s, %s)
        """
        cur.execute(insert_sql, (idx, title, datetime.now(), status, link))
        conn.commit()
        cur.close()
    except Exception as e:
        # If there's an error, rollback the transaction
...
def insert_serve_comparison_to_memory(title):
    if True:
        # Get a connection from the pool
...
def update_serve_comparison_to_memory(title, status, link):
    if True:
        # Get a connection from the pool

        title, idx = title.split('---')
        idx = idx.replace('.docx', '')
        for x in serve_comparison_db:
            if x['idx'] == idx:
                if status:
                    x['status'] = 'SUCCESS'
                    x['link'] = link
...
def update_serve_comparison_to_db(title, status, link):
    conn = None
    try:
        # Get a connection from the pool
        conn = connection_pool.getconn()
        ...
        UPDATE hawkeye_app.serve_comparison_table
        SET status = %s,
            link = %s
        WHERE idx = %s
        """
        cur.execute(insert_sql, (status, link, idx))
        conn.commit()
        cur.close()
    except Exception as e:
        # If there's an error, rollback the transaction
...
with open('all_data3.json') as f:
    all_data3 = json.load(f)
...
db_serve = {'MatchDataShot': sorted(all_data3, key=lambda x: x['match_id'], reverse=False)}
        ...
        for i in range(nor.number):
            ...
            if not nor.columns[i]:
                ...
                if nor.players[i].upper() not in column_name:
                    column_name = nor.players[i] + ' ' + column_name
            if nor.matches[i]:
                print('USE FILTER ONLY MATCHES', nor.players[i])
                data.append({
                    'player': nor.players[i],
                    'matches': [x for x in nor.matches[i] if x in nor.filter_only_matches[i]],
                    'name': column_name.upper()
                })
                #print('DATA IF', i, nor.matches[i], nor.filter_only_matches[i])
            else:
                print('USE ALL MATCHES', nor.players[i])
                data.append({
                    'player': nor.players[i],
                    'matches': nor.filter_only_matches[i],
                    'name': column_name.upper()
                })
                #print('DATA ELSE', i, nor.matches[i])
...
serve_comparison_db = []
@ui.refreshable
def serve_comp_ui_table():

    table_func = ui.refreshable(serve_comp_table_simple)
    ui.markdown('### SERVE COMPARISON STATUS TABLE').classes('mx-auto')
    columns = [{'name': col, 'label': col, 'field': col, 'align': 'center'} for col in ['title', 'status', 'link']]
    columns = [
    ...
    try:
        # Get a connection from the pool
        conn = connection_pool.getconn()
        data_db = pd.read_sql('SELECT * FROM hawkeye_app.serve_comparison_table ORDER BY created_at DESC LIMIT 10', conn)
        rows = data_db.to_dict(orient="records")#[::-1]
        ...
        if conn:
            connection_pool.putconn(conn)
    # for x in serve_comparison_db[::-1]:
    #     rows.append(
    #         {
    #             'title': x['title'],
    #             'status': x['status'],
    ...
    table_func(columns=columns, data=rows, table_classes="text-center w-1/2 mx-auto")
    #     table = ui.table(columns=columns, rows=rows).classes('mx-auto').classes('w-full')
...
async def create_serve_comparison_images(nor, prefix, results):  
    results.visible = True  
    with results:
        ui.spinner('dots', size='xl').classes('mx-auto')
    if all(player for player in nor.players):
        ...
        filename_link = f'https://operationslakedb.blob.core.windows.net/shot-evolution-report/{filename}'
        await run.io_bound(insert_serve_comparison_to_db, filename) # start the hpload
        serve_comp_ui_table.refresh()
        #create_serve_comparison(data, report_id)
        success =await run.cpu_bound(create_serve_comparison, data, report_id)
        #uccess = await run.cpu_bound(create_serve_comparison, data, report_id)
        await run.io_bound(azure_upload_docx, container_client, filename)
        import os
        os.remove(filename)
        await run.io_bound(update_serve_comparison_to_db, filename, success, filename_link)
        serve_comp_ui_table.refresh()
...
def init(fastapi_app: FastAPI) -> None:
    ...
    @ui.page('/shot_evolution_interface', response_timeout=15, dark=True,favicon='https://operationslakedb.blob.core.windows.net/gsa-post-match/fav.png')
    async def report_creation():
        ...
        async def form_view(x):
            ...
            async def on_company_change(i, dialoger):
                ...
                if not len(nor.matches[i]):
                    nor.matches[i] = sorted(list(set([row.match_id for row in filtered_matches])))
                        ...
                        with ui.card().classes('no-shadow').props('flat bordered'):
                            ...
                            with ui.column().classes('items-center'):
                                ...
                                surface_selection = ui.select(
                                    ...
                                    multiple=True,
                                    on_change=lambda i=i, dialog=dialog: on_company_change(i, dialog),
                                    options=sorted(list(set([x['SURFACE'] for x in all_data]))),
                                ).classes('w-60').props('outlined').classes('mx-auto')
                                if nor.surfaces[i]:
        ...
        with ui.column().classes('mx-auto'):
            ...
            results.visible = False
            ui.button(f'Create Shot Evolution Report', on_click=lambda e: insert_data_and_generate_link(nor, 'REPORT', results)).classes('mx-auto')
        ui.space()
        ui.space()
    @ui.page('/serve_comparison_interface', response_timeout=15, dark=True,favicon='https://operationslakedb.blob.core.windows.net/gsa-post-match/fav.png')
    async def serve_comparison_creation():
        ui.markdown('# SERVE COMPARISON CREATOR').classes('mx-auto')
        ...
        async def form_view(x):
            ...
            async def on_company_change(i, dialoger):
                ...
                #match = matches[i].value
                if player:
                    player_name, tour_name = player.split(':')
                    filters['PLAYER'] = player_name
                    nor.players[i] = player_name
                    nor.tours[i] = tour_name
                    ...
                    with ui.column().classes('mx-auto'):
                        ...
                        with ui.card().classes('no-shadow').props('flat bordered'):
                            ...
                            if nor.columns[i]:
                                column_input.set_value(nor.columns[i])
                            ui.separator().classes('w-full')
                            atp_players_here = [x + ':ATP' for x in atp_players]
                            wta_players_here = [x + ':WTA' for x in wta_players]
                            with ui.column().classes('items-center'):
                                player_selection = ui.select(
                                    label='Player',
                                    with_input=True,
                                    ...
                                    on_change=lambda i=i, dialog=dialog: on_company_change(i, dialog),
                                    options=sorted(atp_players_here + wta_players_here)
                                    #options=sorted(list(set([x['PLAYER'] for x in all_data]))),
                                    #options=sorted(list(set([x['PLAYER'] for x in all_data]))),
                                    ).classes('w-60').props('outlined').classes('mx-auto')
                                if nor.players[i]:
        ...
        with ui.column().classes('mx-auto'):
            results = ui.column().classes('w-full justify-center mt-2')
            results.visible = False
            ui.button(f'Create Serve Comparison Report', on_click=lambda e: create_serve_comparison_images(nor, 'REPORT', results)).classes('mx-auto')
        serve_comp_ui_table()
        ui.space()
        ui.space()

    @ui.page('/match_new_list/{prefix}', response_timeout=15, dark=True,favicon='https://operationslakedb.blob.core.windows.net/gsa-post-match/fav.png')
        ...
        def report_view():
                ...
                with ui.tab_panels(tabs).classes('w-full').bind_value(selected_tab, 'number'):
                    ...
                    with ui.tab_panel('v'):
                        ...
                        all_clips = []
                        for cat, clips in CUSTOM_CLIPS.items():
                            for title, url in clips.items():
                                all_clips.append((title, url, cat))
                        ...
                        def prev_clip():
                            vs.index = (vs.index - 1) % len(all_clips)
                            _refresh_video()
                        ...
                        def _refresh_video():
                            title, url, cat = all_clips[vs.index]
                            video_title_el.text = title
                            video_counter_el.text = f'{vs.index + 1} / {len(all_clips)}'
                            video_el.set_source(url)
                            for i, (_, btn) in enumerate(clip_buttons):
                                if i == vs.index:
                                    btn.classes(remove='bg-white text-grey-8', add='bg-primary text-white')
                                else:
                                    btn.classes(remove='bg-primary text-white', add='bg-white text-grey-8')

                        with ui.row().classes('w-full no-wrap gap-0'):
                            # -- sidebar clip list --
                            with ui.column().classes('w-72 min-w-[260px] border-r overflow-y-auto p-3 gap-0') \
                                    .style('max-height: 600px'):
                                for cat, clips in CUSTOM_CLIPS.items():
                                    ui.label(cat.upper()).classes('text-xs font-bold text-gray-400 mt-3 mb-1') \
                                        .style('letter-spacing: 0.08em')
                                    for title, url in clips.items():
                                        idx = len(clip_buttons)
                                        btn = ui.button(
                                            title,
                                            on_click=lambda _, i=idx: select_clip(i),
                                        ).props('flat dense no-caps').classes(
                                            'w-full text-left text-xs bg-white text-grey-8 q-py-xs'
                                        ).style('text-transform: none; justify-content: flex-start')
                                        clip_buttons.append((title, btn))

                            # -- main video player --
                            with ui.column().classes('flex-grow items-center p-4 gap-2'):
                                video_title_el = ui.label(all_clips[0][0]).classes(
                                    'text-xl font-bold text-gray-800'
                                )
                                video_counter_el = ui.label(f'1 / {len(all_clips)}').classes(
                                    'text-sm text-gray-500'
                                )
                                video_el = ui.video(all_clips[0][1]).classes(
                                    'w-full rounded-lg shadow-lg'
                                ).style('max-width: 900px').props('controls')

                                with ui.row().classes('gap-4 mt-2'):
                                    ui.button('Previous', on_click=prev_clip).props('flat')
                                    ui.button('Next', on_click=next_clip).props('flat')

                        # highlight first button
                        if clip_buttons:
                            clip_buttons[0][1].classes(remove='bg-white text-grey-8', add='bg-primary text-white')
    ...
    @ui.page('/movement_report/{match_str}', response_timeout=15, favicon='https://operationslakedb.blob.core.windows.net/gsa-post-match/fav.png')
            ...
            with ui.row().classes('mx-auto'):
                for i in range(x):
                    with ui.column():
                        ...
                        buttonopener = ui.button(f'SELECT MATCHES FOR THE PERIOD', color='white', icon='filter_list').classes('mx-auto')
                    with ui.dialog() as dialog, ui.card():
...
<header class="bg-[url(/images/banner.jpg)] w-full relative">
    ...
    <div class="container relative mx-auto flex items-center  content-center align-middle h-full min-h-[500px]">
    ...
    <div class="mt-10">
        ...
        await button_view(1)
        ui.button('GENERATE DATA', on_click=lambda: tab_report_refreshable.refresh(data, noe.selected_matches, noe.report_names, image_dir, selected_player), color='white').classes('mx-auto')
