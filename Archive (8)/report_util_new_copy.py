...
from card_new2 import get_data_for_matches_new
...
leaderboard2 = pd.read_csv('leaderboard_haddad_new_wta_with_sets.csv')
...
def main3(selected_player_name='BERRETTINI', 
    ...
    data_player = get_data_for_matches_new(selected_player_name, leaderboard2, matches)
    print('DATA PLAYER', matches, data_player)
    data_opponent = get_data_for_matches_new(opponent_name, leaderboard2, matches)
