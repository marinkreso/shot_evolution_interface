...
def return_new_html(ui, movement_json, returnx, items, images, chosen_set):
    ui.markdown(f'### 1st Return'.upper()).classes('mx-auto').tailwind('font-bold')
    if chosen_set == 'ALL':
    ...
    ui.markdown(f'### 1ST RETURNS: DEPTH AND SPEED'.upper()).classes('mx-auto').tailwind('font-bold')
    if chosen_set == 'ALL':
...
def return_new_html2(ui, movement_json, returnx, items, images, chosen_set):
    ...
    ui.markdown(f'### 2nd Return'.upper()).classes('mx-auto').tailwind('font-bold')
    if chosen_set == 'ALL':
    ...
    ui.markdown(f'### 2nd Deuce Return Direction'.upper()).classes('mx-auto').tailwind('font-bold')
    if chosen_set == 'ALL':
    ...
    ui.markdown(f'### 2nd Ad Return Direction'.upper()).classes('mx-auto').tailwind('font-bold')
    if chosen_set == 'ALL':
...
#     ).classes('mx-auto').props('absolute-center')
    ...
    ui.markdown(f'### 1st Serve Direction {movement_json.get("selected_player_name","Player" )}'.upper()).classes('mx-auto').tailwind('font-bold')
    ...
    ui.markdown(f'### {movement_json.get("selected_player_name","Player" )} 1st Serve Placement < 40 cm of the side lines '.upper()).classes('mx-auto').tailwind('font-bold')
    ui.table(
    ...
    #ui.markdown(f'### RALLY LENGTH STATISTICS'.upper()).classes('mx-auto').tailwind('font-bold')
    #ui.image('1stServe.png').classes('mx-auto').classes('w-1/4')
...
#     ).classes('mx-auto').props('absolute-center')
    ...
    ui.markdown(f'### 2nd Serve Direction {movement_json.get("selected_player_name","Player".upper() )}'.upper()).classes('mx-auto').tailwind('font-bold')
    if chosen_set == 'ALL':
    ...
    # ui.markdown(f'### 2nd Serve Placement'.upper()).classes('mx-auto').tailwind('font-bold')
