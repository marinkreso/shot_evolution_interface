...
def create_shot_evolution(report_id, player, data):
    ...
    #with open('hurkacz_shot_evolution.json') as f:
    #    data = json.load(f)
    ...
    with open('html_input_data.json', 'w') as f:
        json.dump(data, f, indent=4)
    #with open(f"{player}_{report_id}.html", "w") as f:
    #    f.write(outputText)
    # As a module
    ...
    html_output = convert_gsa_report(outputText, title="Shot Quality Evolution Report", subtitle="")
